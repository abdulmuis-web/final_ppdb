...
class CreateParentsTmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('parents_tmps', function (Blueprint $table) {
            $table->id();
            $table->char('type', 1)->comment('0:M, 1:F');
            $table->string('name');
            $table->foreignId('city_born_id')->nullable();
            ...
            $table->char('last', 1)->comment('1 :Non Formal/tidak Lulus SD/MI, 2:SD/MI/Sederajat, 3:SMP/MTs/Sederajat, 4:SMA/MA/Sederajat, 5:D3, 6:D4, 7:S1, 8:S2, 9:S3')->nullable();
    ...
    {
        Schema::dropIfExists('parents_tmps');
    }
}